...
Sha256.hash = function(msg) {
    ...
    for (var i=0; i<N; i++) {
        ...
        for (var t=0; t<64; t++) {
            var T1 = h + Sha256.Sig1(e) + Sha256.Ch(e, f, g) + K[t] + W[t];
            var T2 =     Sha256.Sig0(a) + Sha256.Maj(a, b, c);
            h = g;
            g = f;
            f = e;
            e = (d + T1) & 0xffffffff;
 ...
 * @private
 */
Sha256.Sig0  = function(x) { return Sha256.ROTR(2,  x) ^ Sha256.ROTR(13, x) ^ Sha256.ROTR(22, x); };
Sha256.Sig1  = function(x) { return Sha256.ROTR(6,  x) ^ Sha256.ROTR(11, x) ^ Sha256.ROTR(25, x); };
